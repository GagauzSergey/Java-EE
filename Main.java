            ...
            try {
                ...
                switch (text) {
                    ...
                    case "GET ALL REGISTERED USERS":
                        int res3 = Utils.sendReq("/registered");
                        System.out.println(res3);
                        break;

                    case "GET ALL ONLINE USERS":
                        int res4 = Utils.sendReq("/online");
                    ...
                    case "CREATE CHAT_ROOM":
                        ...
                        responseCod = Utils.sendReq("/chat_room_get?chatLogin=" +
                                chatLogin + "&chatRoomName=" + chatRoomName);
                        ...
                        int res5 = m5.send(Utils.getURL() + "/chat_room_post");// и отправляем его по url: Utils.getURL() + "/add"
